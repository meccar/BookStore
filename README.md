...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p cb8e9eb2-ca70-4522-a635-b13767cebe09
```

> `cb8e9eb2-ca70-4522-a635-b13767cebe09` is the password of the certificate, you can change it to any password you want.
